...
if (isset($_POST['submit'])) {
	...
	if (empty($nama) || empty($umur) || empty($email) || empty($tgl_lahir) || empty($jenis_kelamin) || empty($no_telp)) {
		...
		$result = mysqli_query($mysqli, "INSERT INTO biodata (`nama`,umur,`tgl_lahir`, `jenis_kelamin`, `alamat`,`email`, `no_telp`) VALUES ('$nama', '$umur', '$tgl_lahir', '$jenis_kelamin', '$alamat', '$email', '$no_telp')");

		// Display success message
		echo "<p><font color='green'>Data berhasil dimasukkan!</p>";
